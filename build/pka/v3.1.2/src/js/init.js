...
function csvContentLoaded(csvContent){
	...
	$(document).ready(function(){
		...
		var GEOCLIENT_URL = '//maps.nyc.gov/geoclient/v1/search.json?app_key=07368656C6C732062&app_id=pre-k';
		var GOOGLE_URL = 'https://maps.googleapis.com/maps/api/js?client=gme-newyorkcitydepartment&channel=pka&sensor=false&libraries=visualization';
