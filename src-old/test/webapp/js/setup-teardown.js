...
function setup(assert, hooks){
	...
	hooks.CSV_MESSAGES = {
		...
		form_msg_no_apply: 'This form is only a statement of interest and not an application. An Enrollment Specialist will contact you shortly. Please visit <a href="http://nyc.gov/prek" target="_blank" rel="noopener noreferrer">nyc.gov/prek</a> for more information.',
		form_msg_yes_apply: 'This form is only a statement of interest and not an application. An Enrollment Specialist will contact you shortly. Please visit <a href="http://nyc.gov/prek" target="_blank" rel="noopener noreferrer">nyc.gov/prek</a> for more information.',
