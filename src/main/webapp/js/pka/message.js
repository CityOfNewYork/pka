...
pka.messages = [
	...
	{		
		...
		info_name: '<div class="inf-name notranslate" translate="no"><img alt="" src="img/${PREK_TYPE}.png">${NAME}</div>',
		...
		info_seats: '<div class="seats"><span class="inf-name">${school_year} Seats: </span>${SEATS} ${day_length}</div>',
	...
	/*********** Pre-K Finder School VCARD *************/
	{
		...
		vcard_seats: '${school_year} Seats: ${SEATS} ${day_length}\n\n',
