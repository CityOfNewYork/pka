...
const messages = [
	...
	{		
		...
		info_apply_btn: '<div class="capitalize inf-btn apply"><a data-role="button" href="${apply_url}" target="_blank" rel="noopener noreferrer">${btn_apply}</a></div>',
		info_pdf_btn: '<div class="capitalize inf-btn pdf"><a data-role="button" href="${pdf_url}" target="_blank" rel="noopener noreferrer">${btn_pdf}</a></div>',
		...
		info_web: '<div class="web" translate="no"><a data-role="button" href="${WEBSITE}" target="_blank" rel="noopener noreferrer">website</a></div>',
